function varargout = ode15s_md(ode,tspan,y0,options,varargin)
...
while ~done
  ...
  if numel(find(tout>0)) > 1e5
      errorStruct.identifier = 'MyError:TimeLimitReached';
      errorStruct.message = 'Time Limit Reached';
      error(errorStruct);
  end
